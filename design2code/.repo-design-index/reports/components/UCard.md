...
|---|---|
| 组件名 | `UCard` |
| 路径 | `src/components/card/index.vue` |
| 当前状态 | `candidate` |
| 初步分类 | `needs-classification` |
| 建议状态 | `needs-human-review` |
| props 样例 | `width`, `height`, `borderColor`, `backgroundImage`, `backgroundColor`, `rounded`, `select` |
