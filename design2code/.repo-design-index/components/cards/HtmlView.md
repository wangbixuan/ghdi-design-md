...
| 组件名 | `HtmlView` |
| 暴露来源 | `expose.js` |
| importPath | `@/components/form/HtmlView` |
| 源码路径 | `bigboss-base/src/components/form/HtmlView.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `8` |
...
源码位于 `bigboss-base/src/components/form/HtmlView.vue`。扫描到 8 个直接或间接引用样例。
...
- `bigboss-base/src/components/form/EditorVue.vue`
