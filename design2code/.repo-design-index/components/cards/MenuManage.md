...
| 组件名 | `MenuManage` |
| 暴露来源 | `expose.js` |
| importPath | `@/module/admin/MenuManage/menuManage.vue` |
| 源码路径 | `bigboss-base/src/module/admin/MenuManage/menuManage.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `3` |
...
源码位于 `bigboss-base/src/module/admin/MenuManage/menuManage.vue`。扫描到 3 个直接或间接引用样例。
...
真实引用样例文件：
- `bigboss-base/src/module/admin/menu.admin.js`
- `bigboss-base/src/module/open/dev/menus/index.vue`
