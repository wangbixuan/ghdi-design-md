...
| 组件名 | `FlowUserRule` |
| 暴露来源 | `expose.js` |
| importPath | `@/module/open/flow/user_rule/index` |
| 源码路径 | `bigboss-base/src/module/open/flow/user_rule/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `1` |
...
源码位于 `bigboss-base/src/module/open/flow/user_rule/index.vue`。扫描到 1 个直接或间接引用样例。
