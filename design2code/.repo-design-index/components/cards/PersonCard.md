...
| 组件名 | `PersonCard` |
| 暴露来源 | `expose.js` |
| importPath | `./PersonCard.vue` |
| 源码路径 | `bigboss-base/src/components/PersonCard.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `1` |
...
人员卡片组件，通过 username 展示人员信息。

源码位于 `bigboss-base/src/components/PersonCard.vue`。扫描到 1 个直接或间接引用样例。
