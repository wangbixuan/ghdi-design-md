...
| 组件名 | `chartsLine` |
| 暴露来源 | `expose.js` |
| importPath | `./charts/line` |
| 源码路径 | `bigboss-base/src/components/charts/line.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `1` |
...
折线图 ECharts 封装组件，通过 option 渲染趋势图。

源码位于 `bigboss-base/src/components/charts/line.vue`。扫描到 1 个直接或间接引用样例。
