...
| 组件名 | `MultipleChoice` |
| 暴露来源 | `expose.js` |
| importPath | `../module/admin/SelectProject/multipleChoice.vue` |
| 源码路径 | `bigboss-base/src/module/admin/SelectProject/multipleChoice.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `6` |
...
项目多选/多项选择组件，来源于 SelectProject 模块。

源码位于 `bigboss-base/src/module/admin/SelectProject/multipleChoice.vue`。扫描到 6 个直接或间接引用样例。
...
- `bigboss-base/src/components/baseTableV2/module/drawer/search.vue`
