...
| 组件名 | `SelectProject` |
| 暴露来源 | `expose.js` |
| importPath | `../module/admin/SelectProject/index.vue` |
| 源码路径 | `bigboss-base/src/module/admin/SelectProject/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `1` |
...
源码位于 `bigboss-base/src/module/admin/SelectProject/index.vue`。扫描到 1 个直接或间接引用样例。
...
- `selectDependProjectName`：组件会向父级抛出的事件。
...
<SelectProject
  ...
  :type="type"
  @selectDependProjectName="handleSelectDependProjectName"
/>
```
