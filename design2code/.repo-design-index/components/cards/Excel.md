...
| 组件名 | `Excel` |
| 暴露来源 | `expose.js` |
| importPath | `./excel/index` |
| 源码路径 | `bigboss-base/src/components/excel/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `6` |
...
源码位于 `bigboss-base/src/components/excel/index.vue`。扫描到 6 个直接或间接引用样例。
...
- `templateUrl`：源码中识别到的入参，使用前应结合业务含义传值。
...
- `bigboss-base/src/common/util.js`
- `bigboss-base/src/components/baseTable/TableBase.vue`
- `bigboss-base/src/components/excel/export.js`
