...
| 组件名 | `NoticeConfig` |
| 暴露来源 | `expose.js` |
| importPath | `@/components/notice/module/index.vue` |
| 源码路径 | `bigboss-base/src/components/notice/module/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `2` |
...
源码位于 `bigboss-base/src/components/notice/module/index.vue`。扫描到 2 个直接或间接引用样例。
