...
| 暴露来源 | `expose.js` |
| importPath | `./tabs.vue` |
| 源码路径 | `bigboss-base/src/components/tabs.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `8` |
...
通用 tabs 组件，使用 tabs 配置。

源码位于 `bigboss-base/src/components/tabs.vue`。扫描到 8 个直接或间接引用样例。
...
- `bigboss-base/src/components/form/uploadFile/module/ViewFile.vue`
