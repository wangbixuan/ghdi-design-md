...
| 组件名 | `documentDesc` |
| 暴露来源 | `expose.js` |
| importPath | `@/module/admin/doc/documentDesc.vue` |
| 源码路径 | `bigboss-base/src/module/admin/doc/documentDesc.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `3` |
...
源码位于 `bigboss-base/src/module/admin/doc/documentDesc.vue`。扫描到 3 个直接或间接引用样例。
...
- `bigboss-base/src/module/admin/doc/menu.js`
