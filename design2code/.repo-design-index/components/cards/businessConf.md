...
| 组件名 | `businessConf` |
| 暴露来源 | `expose.js` |
| importPath | `./form/businessConfiguration/index.vue` |
| 源码路径 | `bigboss-base/src/components/form/businessConfiguration/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `2` |
...
业务配置页面级组件，用于初始化或维护业务配置。

源码位于 `bigboss-base/src/components/form/businessConfiguration/index.vue`。扫描到 2 个直接或间接引用样例。
