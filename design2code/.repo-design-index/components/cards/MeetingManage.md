...
| 组件名 | `MeetingManage` |
| 暴露来源 | `expose.js` |
| importPath | `@/module/infor-syn/meeting/index.vue` |
| 源码路径 | `bigboss-base/src/module/infor-syn/meeting/index.vue` |
| 说明状态 | `human-reviewed` |
| 推荐状态 | `allowed` |
| 引用样例数量 | `1` |
...
源码位于 `bigboss-base/src/module/infor-syn/meeting/index.vue`。扫描到 1 个直接或间接引用样例。
